					...
					<div class="modal fade" id="exampleModal-4" tabindex="-1"
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								...
								<f:form action="saveEvent" method="post"
								...
								<div class="card-body">
									<div class="list-wrapper">
										<c:forEach items="${eventlist}" var="i">
											<a href="eventNameList?eyear=${i}">
												<button type="submit"
													style="padding-left: 50px; padding-right: 50px; margin: 10px; padding-top: 10px; padding-bottom: 10px;"
