				...
				<div class="content-wrapper">
					...
					<div class="modal fade" id="exampleModal-4" tabindex="-1"
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								...
								<f:form action="saveEventFromCoordinator" method="post"
										...
										<div class="form-group">
											...
											<div class="input-group col-xs-12">
												<f:input type="text" id="fileName"
													...
													placeholder="Upload Image" path="eventFileName" />
										...
										<div class="form-group row">
											...
											<div class="col-lg-8">
												<f:input class="form-control" maxlength="20"
													name="eventName" id="defaultconfig-2" type="text"
													path="eventName" />
											</div>
										</div>
										<div class="form-group row">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">${uName}Gallery</h4>
									<div id="lightgallery" class="row lightGallery">
										<c:forEach items="${membersPosts}" var="i">

											<a
												href="<%=request.getContextPath()%>/adminResources/images/${i.eventFileName}"
												class="image-tile"><img
												src="<%=request.getContextPath()%>/adminResources/images/${i.eventFileName}"
												alt="image small"
												title="Event Name: ${i.eventName}, Year:  ${i.year}"></a>
										</c:forEach>
									</div>
								</div>
							</div>
