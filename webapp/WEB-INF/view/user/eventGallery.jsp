		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					...
					<div class="col-lg-12">
						<div class="bg-secondary p-4">
							<div id="profile-list-left" class="py-2">
								<h3 style="margin-bottom: 20px;">Events Gallery</h3>
								<c:forEach items="${eventNameList}" var="i">
									<div class="card rounded mb-2">
										<div class="card-body p-3">
											<div class="media">
												<a href="eventPostPage?eName=${i.eventName}&year=${i.year}"><img
													src="<%=request.getContextPath()%>/adminResources/images/${i.eventFileName}"
													alt="image" class="img-sm mr-3 rounded-circle"></a>
												<div class="media-body">
													<h6 class="mb-1">${i.eventName}</h6>
												</div>
											</div>
										</div>
									</div>
					...
					<%-- <f:form action="saveEventPost" method="post"
						modelAttribute="eventGallery">
						<div class="form-group">
							<input type="file" name="img[]" class="file-upload-default">
							<div class="input-group col-xs-12">
								<f:input type="text" id="fileName"
									class="form-control file-upload-info" disabled=""
									placeholder="Upload Image" path="fName" />
					...
					<c:forEach items="${eventFileList}" var="i">
							...
							<div class="card">
								<form action="deletePost" method="post">
									<div class="card-body text-center">
										<div>
											<img
												src="<%=request.getContextPath()%>/adminResources/images/${i.fName}"
