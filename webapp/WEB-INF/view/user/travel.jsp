				...
				<div class="content-wrapper">
					...
					<div class="modal fade" id="exampleModal-4" tabindex="-1"
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								...
								<f:form action="saveTravelPost" method="post"
									modelAttribute="travelVo">
										...
										<div class="form-group">
											...
											<div class="input-group col-xs-12">
												<f:input type="text" id="fileName"
													...
													placeholder="Upload Image" path="travelFileName" />
										...
										<div class="form-group row">
											...
											<div class="col-lg-8">
												<f:input class="form-control" maxlength="20"
													name="countryName" id="defaultconfig-2" type="text"
													path="country" />
											</div>
										</div>
										<div class="form-group row">
											...
											<div class="col-lg-8">
												<f:input class="form-control" maxlength="20"
													name="placeName" id="defaultconfig-2" type="text"
													path="place" />
											</div>
										</div>
										<div class="form-group row">
											...
											<div class="col-lg-8">
												<f:input class="form-control" maxlength="20" name="year"
					...
					<div class="dropdown" style="float: right;">
						...
						<div class="dropdown-menu"
							aria-labelledby="dropdownMenuIconButton6" style="">
							<a class="dropdown-item" href="travelYear">Year</a> <a
								class="dropdown-item" href="travelCountry">Country</a> <a
								class="dropdown-item" href="travelPlace">Place</a>
						</div>
					</div>
						...
						<c:forEach items="${travelList}" var="i">
							<div class="col-md-4 col-sm-6 grid-margin stretch-card">
								<div class="card text-center">
									<div class="card-body">
										<img
											src="<%=request.getContextPath()%>/adminResources/images/${i.travelFileName}"
											class="img-lg rounded-circle mb-2" alt="profile image">
										<c:choose>
											<c:when test="${sort=='year'}">
												<a href="travelGallery?sort=${i.year}&select=${sort}"><h3>${i.year}</h3></a>
											</c:when>
											<c:when test="${sort=='country'}">
												<a href="travelGallery?sort=${i.country}&select=${sort}"><h3>${i.country}</h3></a>
											</c:when>
											<c:otherwise>
												<a href="travelGallery?sort=${i.place}&select=${sort}"><h3>${i.place}</h3></a>
											</c:otherwise>
										</c:choose>
